<template>
  <footer
    ...
    <div class="container mx-auto px-4 py-16 relative">
      <div class="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-12 mb-16">
        <!-- Brand -->
        ...
        <div class="min-w-0">
          ...
          <div class="space-y-4">
            <a v-if="config?.contact?.telegram" :href="config.contact.telegram" target="_blank"
              ...
              class="flex w-full min-w-0 items-center gap-3 text-sm hover:text-gray-900 dark:hover:text-white transition-colors p-3 rounded-lg bg-gray-50 dark:bg-white/5 hover:bg-gray-100 dark:hover:bg-white/10 border border-gray-100 dark:border-white/5 hover:border-gray-200 dark:hover:border-white/10">
            ...
            <div v-if="wechatQRCodeUrl"
              class="flex min-w-0 flex-col items-start gap-3 rounded-xl border theme-border theme-surface-soft p-3 sm:flex-row sm:items-center lg:flex-col lg:items-start xl:flex-row xl:items-center">
              <div class="shrink-0 rounded-lg border border-gray-200 bg-white p-1.5 shadow-sm dark:border-white/10">
                <img
                  ...
                  loading="lazy"
                  decoding="async"
                  class="h-24 w-24 rounded-md object-contain sm:h-20 sm:w-20 lg:h-24 lg:w-24"
                >
              </div>
              <div class="min-w-0">
